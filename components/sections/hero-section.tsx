        ...
        <Reveal>
          <div>
            ...
            <div className="mt-7 grid gap-3 sm:flex sm:flex-wrap sm:items-center">
              <Button href="/contacto" ariaLabel="Ir para contacto e pedir diagnóstico gratuito" className="w-full sm:w-auto">
                Pedir diagnóstico gratuito
              </Button>
              <Button href="/servicos" variant="secondary" ariaLabel="Ir para a secção de serviços" className="w-full sm:w-auto">
                Ver serviços
              </Button>
            </div>
          ...
          <div className="hidden sm:block card-premium dashboard-glass soft-grid relative overflow-hidden p-4 sm:p-7">
            ...
            <div className="rounded-2xl border border-slate-200/80 bg-white/95 p-4 sm:p-5">
              <div className="flex items-center justify-between">
                <p className="text-sm font-semibold text-slate-800">Dashboard de crescimento</p>
              ...
              <div className="mt-5 rounded-xl border border-slate-200 bg-slate-50 p-3">
                <div className="mb-2 flex items-center justify-between">
                  <p className="text-xs font-semibold uppercase tracking-[0.08em] text-slate-500">Crescimento mensal</p>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <div className="rounded-xl border border-slate-200 bg-gradient-to-r from-cyan-50 to-blue-50 p-3">
                <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-slate-500">Foco total</p>
                <p className="mt-1 text-sm font-semibold text-slate-900">Negócios locais</p>
              </div>
              <div className="rounded-xl border border-slate-200 bg-white/95 p-3">
                <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-slate-500">Diagnóstico</p>
                <p className="mt-1 text-sm font-semibold text-slate-900">Gratuito</p>
              </div>
            </div>
          </div>
        </Reveal>
