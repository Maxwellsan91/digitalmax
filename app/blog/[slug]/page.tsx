    ...
    <>
      ...
      <main id="main-content" className="section-block section-pattern">
        <article className="section-shell">
          ...
          <h1 className="mt-3 text-4xl font-semibold tracking-tight text-slate-950 sm:text-5xl">{post.title}</h1>
          <p className="mt-5 max-w-3xl text-lg leading-relaxed text-slate-600">{post.intro}</p>
